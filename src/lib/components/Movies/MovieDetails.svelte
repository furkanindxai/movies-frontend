<script>
    ...
    import movieControllerInstance from "../../controllers/movieController.js"

    let movieJSON = 0;
	onMount(async () => {
        movieJSON = await movieControllerInstance.getMovieController(movieId, $authStore.roles, $authStore.token)
	});
</script>
