      ...
      {#if $authStore.isAuth === 0}
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item">
            ...
            data-bs-whatever="@mdo" aria-current="page">Sign up</button>
          </li>
          <li class="nav-item">
            <button type="button" class="nav-link active" data-bs-toggle="modal" data-bs-target="#signInModal" 
            data-bs-whatever="@mdo" aria-current="page">Sign in</button>
          </li>
        </ul>
